...
declare module IOUtils {
    function createFileAndFolderStructure(ioHost: IIO, fileName: string, useUTF8?: boolean): ITextWriter;
...
declare class ErrorReporter implements ITextWriter {
    public ioHost: IIO;
    public hasErrors: boolean;
    constructor(ioHost: IIO);
    public Write(s: string): void;
...
declare class CommandLineHost implements TypeScript.IResolverHost {
    ...
    public errorReporter: (err: string) => void;
    public pathMap: any;
    public resolvedPaths: any;
    constructor(compilationSettings: TypeScript.CompilationSettings, errorReporter: (err: string) => void);
